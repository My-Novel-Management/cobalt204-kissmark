...
def ramen(w: World):
    ...
    return w.scene("ラーメン屋",
            ...
            mizu.talk("ん？　なぁに？"),
            h.do("そんな$Sの視線に気づいて彼女がマスラカの多い目を向けた"),
            hana.talk("うまそうだなって"),
...
def oldtalk(w: World):
    ...
    return w.scene("昔話",
            ...
            h.do("あとで他の女子から親が離婚して色々あったんだって聞いたけど、ほんとかどうか$Sは知らない"),
            )
...
def goto_univ(w: World):
    ...
    return w.scene("大学に向かう",
            ...
            mizu.talk("えっと"),
            h.do("水川は助けを求めるように$Sを見てくるから",
                "仕方なく代わりに答えてやる"),
            hana.talk("サークルは軽音入ってるらしいんで"),
            kitami.talk("あっそ"),
            h.do("先輩はそのまま立ち去るかと思ったが", "水川が気に入ったのか",
            ...
            h.do("水川は困った様子で何度も$Sに助けて欲しいと視線を投げる。",
...
def kissmark(w: World):
    ...
    return w.scene("キスマーク",
            h.hear("リノリウムの床の上を$Sと水川の足音だけが滑る"),
            h.do("通路の一番奥まで歩いていき、そこの教室に誰もいないことを確認し、"),
            mizu.talk("え？"),
            h.do("ドアを開けて中に入った"),
            hana.talk("入れよ"),
            mizu.talk("う、うん"),
            h.do("水川を机に座らせると、別の机の上に過去問の束を放り出して$Sは自分のシャツのボタンを外す"),
            mizu.talk("は……蜂須賀君"),
            ...
            h.do("ブラジャーの花柄に手を置いて", "露出した素肌に唇を合わせる。",
                    "そこに思い切り歯を立てた"),
